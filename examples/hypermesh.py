...
if __name__ == "__main__":
    ...
    # demonstrate vertex group display
    ...
    hex_mesh.face_groups.import_all_vertex_groups()
    ...
    del hex_mesh.vertex_groups["hull"]
    hex_mesh.face_groups.export_vertex_group("hull")
    hex_mesh.extract_vertex_group("hull").show()

    # tetrahedron mesh
    tet_mesh = gus.io.hmascii.load("input/hypermesh_tet.hmascii")
    tet_mesh.shrink().show()

    tet_mesh.face_groups.import_vertex_group("hull")
