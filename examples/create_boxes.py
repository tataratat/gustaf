...
The numer of vertices is defined by the resolution.
Here, two vertices along the x-axis and three vertices along the
y-axis are definded. In other words, a mesh of size 2x2 with 2 (1x2) elements
is created.
...
the y-axis and 4 vertices aling the z-axis are definded.In other words, a mesh
...
elements. The bounds of the mesh are two diagonal corners in the
x-y-directions, in this example [x=0, y=0] (origin) and [2, 2].
The numer of vertices is defined by the resolution. Here, three vertices
along the x-axis and three vertices along the y-axis are definded.
