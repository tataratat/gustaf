...
if __name__ == "__main__":
    ...
    vertices = gus.create.vertices.raster(
        bounds=[[-1, 0, 5], [4, 1, 10]], resolutions=v_res
    )
    ...
    control_points[22] = [1.5, 0.5, 0.5]
    control_points[2] = [0.25, 0.25, 0.75]
    ...
    ffd_with_out_mesh.show(
        title="Spline without defined mesh at "
