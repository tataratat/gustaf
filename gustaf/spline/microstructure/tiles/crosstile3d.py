...
class CrossTile3D(TileBase):
    ...
    def closing_tile(
        ...
        **kwargs,
        ...
        if closure == "z_min":
            ...
            spline_list.append(
                base.Bezier(degrees=[1, 1, 1], control_points=cps_corner)
            )
            ...
            spline_list.append(
                base.Bezier(
                    degrees=[1, 1, 1],
                    control_points=(
                        cps_corner + np.array([0.0, inv_boundary_width, 0.0])
                    ),
                )
            )
            ...
            spline_list.append(
                base.Bezier(
                    degrees=[1, 1, 1],
                    control_points=(
                        cps_corner + np.array([inv_boundary_width, 0.0, 0.0])
                    ),
                )
            )
            ...
            spline_list.append(
                base.Bezier(degrees=[1, 1, 1], control_points=center_cps)
            )
            ...
            spline_list.append(
                base.Bezier(
                    ...
                    control_points=np.maximum(
                        center_cps - np.array([center_width, 0, 0]), 0
                    ),
                )
            )
            ...
            spline_list.append(
                base.Bezier(
                    degrees=[1, 1, 1],
                    control_points=np.maximum(
                        center_cps - np.array([0, center_width, 0]), 0
                    ),
                )
            )
            ...
            spline_list.append(
                base.Bezier(
                    ...
                    control_points=np.minimum(
                        center_cps + np.array([center_width, 0, 0]), 1.0
                    ),
                )
            )
            ...
            spline_list.append(
                base.Bezier(
                    degrees=[1, 1, 1],
                    control_points=np.minimum(
                        center_cps + np.array([0, center_width, 0]), 1.0
                    ),
                )
            )
            branch_cps = np.array(
            ...
            spline_list.append(
                base.Bezier(degrees=[1, 1, 2], control_points=branch_cps)
            )
    ...
    def create_tile(self, parameters=None, center_expansion=1.0, **kwargs):
        ...
        x_min_spline = base.Bezier(
            degrees=[2, 1, 1], control_points=x_min_cps + [0.5, 0.5, 0.5]
        )
        # X-Min-Branch
        ...
        x_max_spline = base.Bezier(
            degrees=[2, 1, 1], control_points=x_max_cps + [0.5, 0.5, 0.5]
        )
        ...
        y_min_spline = base.Bezier(
            degrees=[1, 2, 1], control_points=y_min_cps + [0.5, 0.5, 0.5]
        )
        # Y-Min-Branch
        ...
        y_max_spline = base.Bezier(
            degrees=[1, 2, 1], control_points=y_max_cps + [0.5, 0.5, 0.5]
        )
        ...
        z_min_spline = base.Bezier(
            degrees=[1, 1, 2], control_points=z_min_cps + [0.5, 0.5, 0.5]
        )
        # Y-Min-Branch
        ...
        z_max_spline = base.Bezier(
            degrees=[1, 1, 2], control_points=z_max_cps + [0.5, 0.5, 0.5]
        )
