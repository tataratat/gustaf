...
class InverseCrossTile3D(TileBase):
    """Class that provides necessary functions to create inverse micro tile,
    that can be used to describe the domain within a microstructure."""

    def __init__(self):
        """Simple inverse cross tile to tile with linear-quadratic branches and
    ...
    def create_tile(
        ...
        **kwargs,
        ...
        """Create an inverse micro tile based on the parameters that describe
        ...
        # Auxiliary values for smoothing (mid-branch thickness)
        ...
        x_min_y_min = np.array(
            [
                ...
                [-separator_distance, -0.5, -aux_column_width],
                [-y_min_r, -0.5, -y_min_r],
                [-0.5, -separator_distance, -aux_column_width],
        ...
        x_min_z_min = np.array(
            [
                ...
                [-separator_distance, -aux_column_width, -0.5],
                [-z_min_r, -z_min_r, -0.5],
                [-0.5, aux_column_width, -0.5],
                [-separator_distance, aux_column_width, -0.5],
                [-z_min_r, z_min_r, -0.5],
                [-0.5, -aux_column_width, -separator_distance],
        ...
        y_min_z_min = np.array(
            [
                ...
                [aux_column_width, -0.5, -0.5],
                [-aux_column_width, -separator_distance, -0.5],
                [aux_column_width, -separator_distance, -0.5],
                [-z_min_r, -z_min_r, -0.5],
                [z_min_r, -z_min_r, -0.5],
                [-aux_column_width, -0.5, -separator_distance],
                [aux_column_width, -0.5, -separator_distance],
        ...
        x_min_y_min_z_min = np.array(
            [
                [-0.5, -0.5, -0.5],
                [-separator_distance, -0.5, -0.5],
                [-aux_column_width, -0.5, -0.5],
                [-0.5, -separator_distance, -0.5],
                [-separator_distance, -separator_distance, -0.5],
                [-aux_column_width, -separator_distance, -0.5],
                [-0.5, -aux_column_width, -0.5],
                [-separator_distance, -aux_column_width, -0.5],
                [-z_min_r, -z_min_r, -0.5],
                [-0.5, -0.5, -separator_distance],
                [-separator_distance, -0.5, -separator_distance],
                [-aux_column_width, -0.5, -separator_distance],
