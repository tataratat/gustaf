...
def show(
    ...
    --------
    things_to_show: dict
      list of gustaf objects that are showable.
    """
    allowed_dim_combo = (
        (1, 2),
        (1, 3),
    ...
    # iff backend is vedo, we provide fancier visualization
        ...
        if parametric_space and spline.para_dim > 1:
            ...
            from gustaf.create.splines import knot_vector_bounded
...
class BSpline(splinelibpy.BSpline, GustavBase):
    ...
    def __init__(
        ...
        """
        BSpline of gustaf. Inherited from splinelibpy.BSpline.
...
class Spline(splinelibpy.Spline):
    def __init__(
        ...
        """
        gustaf Spline class, derived from splinelibpy.Spline.
        Still an abstact.
